			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td class="tal">선경</td>
						<td class="tac">이순신</td>
						<td class="tac"><a href="state.php" class="btn bgLorange">청약생성중</a></td>
					</tr>
					<tr>
						<td class="tac">2020-11-10</td>
						<td class="tal">경원</td>
						<td class="tac">이기자</td>
						<td class="tac"><a href="<?=$rootDir?>/subscription/view.php" class="btn bgLblue">가설조회</a></td>
					</tr>
					<tr>
						<td class="tac">2020-11-10</td>
						<td class="tal">경원</td>
						<td class="tac">이기자</td>
						<td class="tac"><a href="state.php" class="btn bgLgreen">청약신청</a></td>
					</tr>
					<tr>
						<td class="tac">2020-11-10</td>
						<td class="tal">경원</td>
						<td class="tac">이기자</td>
						<td class="tac"><a href="view.php" class="btn bgLgray">청약서열람</a></td>
					</tr>
					<tr>
						<td class="tac">2020-11-10</td>
						<td class="tal">경원</td>
						<td class="tac">이기자</td>
						<td class="tac"><a href="state.php" class="btn bgLred">청약서반려</a></td>
					</tr>
				</tbody>
				<tfoot>
					<tr>
